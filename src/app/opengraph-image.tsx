  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#f2efe6", color: "#111111", padding: 64, fontFamily: "Syne", fontWeight: 800 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", fontSize: 92, lineHeight: 0.95, letterSpacing: -3 }}>
          <span>The cheapest USPS &amp; UPS rates.</span>
          <span style={{ color: "#2d5bff" }}>No monthly fee.</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "4px solid #111111", paddingTop: 24, fontSize: 22, fontWeight: 800, textTransform: "uppercase", letterSpacing: 2 }}>
