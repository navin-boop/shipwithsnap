...
export function SignUpForm() {
  ...
  return (
    <form action={action} className="flex flex-col gap-5" noValidate>
      <Input name="email" type="email" label="Work email" placeholder="you@yourstore.com" autoComplete="email" error={fe.email} required />
      ...
      <Input name="shipFromZip" inputMode="numeric" label="Ship-from ZIP" placeholder="11201" autoComplete="postal-code" error={fe.shipFromZip} required />
